    ...
    mergeCells: {
        ...
        handler() {
            ...
            const rowspan = tableContainer.rows().reduce((sum, row) => {
                ...
                if (rowRect.y > this.boundary.y - ERROR_LIMIT &&
            ...
            const colspan = this.columnToolCells.reduce((sum, cell) => {
                ...
                if (cellRect.x > this.boundary.x - ERROR_LIMIT &&
    ...
    menuInitial({ table, left, top }) {
        ...
        for (let name in this.menuItems) {
            if (this.menuItems[name]) {
                ...
                this.domNode.appendChild(this.menuItemCreator(Object.assign({}, MENU_ITEMS_DEFAULT[attribute], this.menuItems[name])));
...
//# sourceMappingURL=table-operation-menu.js.map