...
export function matchTableCell(node, delta, scroll) {
    ...
    return delta.reduce((newDelta, op) => {
        if (op.insert && typeof op.insert === 'string' &&
            ...
            newDelta.insert(op.insert, Object.assign({}, Object.assign({}, { row: rowId }, op.attributes.table), { 'table-cell-line': { row: rowId, cell: cellId, rowspan, colspan, 'cell-bg': cellBg } }, _omit(op.attributes, ['table'])));
        }
        else {
...
export function matchTableHeader(node, delta, scroll) {
    ...
    return delta.reduce((newDelta, op) => {
        if (op.insert && typeof op.insert === 'string' &&
            op.insert.startsWith('\n')) {
            newDelta.insert(op.insert, Object.assign({}, { 'table-cell-line': { row: rowId, cell: cellId, rowspan, colspan } }));
        }
        else {
            newDelta.insert(op.insert, Object.assign({}, _omit(op.attributes, ['table', 'table-cell-line'])));
        }
...
//# sourceMappingURL=node-matchers.js.map